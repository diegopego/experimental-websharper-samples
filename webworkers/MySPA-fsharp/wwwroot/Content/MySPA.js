...
{
 "use strict";
 var MySPA,Client,EventTarget,Event,WebSharper,Operators,Obj,UI,Var$1,Templating,Runtime,Server,TemplateInstance,Arrays,ProviderBuilder,ListModel,Unchecked,MySPA_Templates,Handler,Var,ConcreteVar,Snap,System,Guid,SC$1,JavaScript,Pervasives,Client$1,Templates,Doc,Abbrev,Fresh,Collections,Dictionary,Node,View,Object,AttrProxy,Blob,CheckedInput,Numeric,HashSet,Seq,TemplateInitializer,JS,DictionaryUtil,Enumerator,T,WindowOrWorkerGlobalScope,SC$2,Docs,SC$3,DocElemNode,CharacterData,Storage,Elt,Element,Prepare,Slice,DomUtility,KeyCollection,An,Settings,Mailbox,Attrs,Dyn,Array,ArrayStorage,Attrs$1,AttrModule,List,T$1,Strings,Updates,ValueCollection,Docs$1,RunState,NodeSet,Concurrency,Anims,SC$4,HashSetUtil,BindVar,SC$5,SC$6,AppendList,SC$7,DynamicAttrNode,Error,KeyNotFoundException,Scheduler,Easing,AsyncBody,SC$8,CT,HashSet$1,String,CancellationTokenSource,DomNodes,Queue,Char,DateUtil,OperationCanceledException,Lazy,SC$9,LazyExtensionsProxy,LazyRecord,console,Runtime$1,Math,Date;
 ...
 {
  var myWorker,echoWorker,newName,_,b,t,_this,L,_this$1,p,i;
  console.log("The main thread wrote: main thread was initialized.");
  myWorker=new Global.Worker(Runtime$1.ScriptPath("MySPA","MySPA.worker.js"));
  myWorker.onmessage=function(event)
  {
   console.log(event.data);
   return myWorker.terminate();
  };
  echoWorker=new Global.Worker(Runtime$1.ScriptPath("MySPA","MySPA.worker0.js"));
  echoWorker.onmessage=function(event)
  {
   return console.log("Main thread says: Received message from echoWorker thread: "+Global.String(event.data));
  };
  ...
  _=(b=(t=(_this=(L=Doc.Convert(function(name)
  {
   ...
   return(b$1=(_this$2=new ProviderBuilder.New$1(),(_this$2.h.push({
    ...
    $0:"name",
    $1:name
   }),_this$2)),(p$1=Handler.CompleteHoles(b$1.k,b$1.h,[]),(i$1=new TemplateInstance.New(p$1[1],MySPA_Templates.listitem(p$1[0])),b$1.i=i$1,i$1))).get_Doc();
  ...
  },function()
  {
   ...
   echoWorker.postMessage("Hello, worker! "+Global.String(newName.Get())+" was added.");
   newName.Set("");
  })),t)),(p=Handler.CompleteHoles(b.k,b.h,[["name",0,null]]),(i=new TemplateInstance.New(p[1],MySPA_Templates.main(p[0])),b.i=i,i))).get_Doc();
 ...
 MySPA_Templates.listitem=function(h)
 {
 ...
 MySPA_Templates.main=function(h)
 {
  Templates.LoadLocalTemplates("index");
  return h?Templates.NamedTemplate("index",{
   $:1,
 ...
 Templates.InlineTemplate=function(el,fillWith)
 {
  ...
  function tryGetAsDoc(name)
  {
   ...
   return m[0]?m[1].$==0?{
    ...
    $:1,
    $0:Doc.TextView(View.Map(function(v)
    {
  ...
  function wsdomHandling()
  {
   Templates.foreachNotPreservedwsDOM("[ws-dom]",function(e$1)
   {
    ...
    if(m[0])
     m[1].$==14?(_var=m[1].$1,e$1.removeAttribute("ws-dom"),toWatch=e$1,mo=new Global.MutationObserver(function($4,mo$1)
     {
  ...
  Templates.foreachNotPreserved(el,"[ws-var]",function(e$1)
  {
   ...
   if(m[0])
    m[1].$==10?addAttr(e$1,AttrModule.Value(m[1].$1)):m[1].$==11?addAttr(e$1,AttrModule.Checked(m[1].$1)):m[1].$==12?addAttr(e$1,AttrModule.DateTimeValue(m[1].$1)):m[1].$==13?addAttr(e$1,AttrModule.FileValue(m[1].$1)):m[1].$==15?addAttr(e$1,AttrModule.IntValue(m[1].$1)):m[1].$==16?addAttr(e$1,AttrModule.IntValueUnchecked(m[1].$1)):m[1].$==17?addAttr(e$1,AttrModule.FloatValue(m[1].$1)):m[1].$==18?addAttr(e$1,AttrModule.FloatValueUnchecked(m[1].$1)):console.warn("Var hole filled with non-Var data",name);
  });
