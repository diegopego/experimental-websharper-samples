...
(function(a){"use strict";var b,c,d,e;b=a.EventTarget;c=a.WindowOrWorkerGlobalScope;d=a.WorkerGlobalScope;e=a.console;e.log("This was written from the worker!");a.postMessage("This worker's job is done, it can be terminated.");}(self));
